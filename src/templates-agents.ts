/** Agent guide templates (AGENTS.md / CLAUDE.md) shipped with every project. */

export function genAgentGuide(fileName: "AGENTS.md" | "CLAUDE.md"): string {
  return `# Agent guide (${fileName}) — building apps with creatify-openapi
